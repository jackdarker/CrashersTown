"use strict";
//a graphical carddealing framework somewhat inspired by https://github.com/einaregilsson/cards.js
...
(function(definition) {
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') {
      ...
      window.gm.startCardGame = exports.game;
    }
    ...
    /*  a visible pile of cards showing either back or face of top card */
    function Pile(options) {  this.init(options); }
    ...
    /* a collection of cards from what a hand is pulled */
    function Deck(options) {  this.init(options);  }
    ...
    function init(options) {
        ...
        debugger
        var lowerhand = new Hand({faceUp:true,  y:340});
        lowerhand.addCard(new Card('h', 1, opt.table));
        lowerhand.render();
    }
    let data ={ //internal state of game
        start: init, //ref to start-function
        Hand:Hand,
        Deck:Deck,
        Pile:Pile,
        Card:Card,
